...
public class FormMain extends javax.swing.JDialog implements DocumentListener {
    ...
    private void addBankNotes() {
        Node chainCurrentNode = chain;
        while (chainCurrentNode != null) {
            if (chainCurrentNode instanceof Node100) {
                chainCurrentNode.addBanknote(20);
            }
            if (chainCurrentNode instanceof Node50) {
                chainCurrentNode.addBanknote(20);
            }
            if (chainCurrentNode instanceof Node20) {
                chainCurrentNode.addBanknote(20);
            }
            if (chainCurrentNode instanceof Node1) {
                chainCurrentNode.addBanknote(10);
            }

            chainCurrentNode = chainCurrentNode.getNext();
        }
    }
    ...
    private void printCurrentState() {
        Node chainCurrentNode = chain;
        while (chainCurrentNode != null) {
            System.out.println(chainCurrentNode);
            chainCurrentNode = chainCurrentNode.getNext();
        }
